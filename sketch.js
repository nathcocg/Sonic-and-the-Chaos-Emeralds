var w1, w2, w3, w4, w5, w6, w7, w8, w9, iw1, iw2, iw3, iw4, iw5, iw6, iw7, iw8, iw9, iw10, iw11, iw12, iw13, iw14;
var s, edges, spb1, spb3, spb3, spb4, spb5, r1, r2, e1, e2, e3, e4, e5, e6, e7, eM, bgs, gS, tS;
var bgImg, sImg, s2Img, spbImg, rImgL, rImgR, e1I, e2I, e3I, e4I, e5I, e6I, e7I, sSI;
var points = 0;
...
function preload() {
  ...
  sSImg = loadImage("./assets/ss1-removebg-preview.png");
  bgs = loadSound("./assets/backgroundSound2.mp3");
  gS = loadSound("./assets/collectinggems.wav");
  tS = loadSound("./assets/transformation.wav");
  dS = loadSound("./assets/death.wav");
}
...
function setup() {
  ...
  iw6.visible = false;
  iw7 = createSprite(width/12*0.5+500, height-50, width/70, height/5+20); // spb1 right/spb2 right
  iw7.visible = false;
  ...
  iw13.visible = false;
  iw14 = createSprite(width/12*0.5+550, height-50, width/70, height/7); // spb3 left
  iw14. visible = false;
  ...
  spb1.scale = 0.2;
  spb1.velocityX = 2;
  spb2 = createSprite(width/4+148, height-116);
  ...
  e2.addImage(e2I);
  e2.scale = 0.03;
  e3 = createSprite(width/2-50, height-260);
  e3.addImage(e3I);
  e3.scale = 0.05;
...
function draw() {
  ...
  if(s.isTouching(e6) && points >=5){
    e6.destroy();
    eM = createSprite(width/4*2.5+200, height-700);
    eM.addImage(e7I);
    eM.scale = 0.03;
  }
  ...
  /*if(s.isTouching(eM)){
    eM.destroy();
    s.destroy();
    sS = createSprite(width/4*2.5+200, height-700);
    sS.addImage(sSImg);
    sS.scale = 0.5;
  }*/
  ...
  if(spb2.isTouching(iw7)){
    spb2.velocityX = -2.5;
  }
  if(spb2.isTouching(iw13)){
    spb2.velocityX = 2.5;
  }
  
  if(spb3.isTouching(iw8)){
    spb3.velocityX = -2.5;
  }
  if(spb3.isTouching(iw14)){
    spb3.velocityX = 2.5;
  }

  if(spb4.isTouching(iw10)){
    spb4.velocityX = -2.5;
  }
  if(spb4.isTouching(iw9)){
    spb4.velocityX = 2.5;
  }
  
  if(spb5.isTouching(iw12)){
    spb5.velocityX = -3.5;
  }
  if(spb5.isTouching(iw11)){
    spb5.velocityX = 3.5;
  }

  if(s.isTouching(spb1)||s.isTouching(spb2)||s.isTouching(spb3)||s.isTouching(spb4)||s.isTouching(spb5)||s.isTouching(r1)||s.isTouching(r2)){
    dS.play();
    s.x = width/12*0.5;
    s.y = height-50;
  }
